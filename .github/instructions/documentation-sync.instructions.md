...
- When changing routing metadata, verify that `applyTo` globs and the customization inventory still match the current `.github/` layout and `.vscode/settings.json` discovery settings.
