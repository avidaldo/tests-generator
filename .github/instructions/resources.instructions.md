...
- For JSON export work, read [editor/file_io/state_io.py](../../editor/file_io/state_io.py) and [resources/json_to_moodle_xml.py](../../resources/json_to_moodle_xml.py) together. The JSON schema comes from `state_io.py`; the export CLI defaults to `lista` questions only.
