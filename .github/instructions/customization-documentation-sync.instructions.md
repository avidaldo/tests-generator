...
- Treat [AGENTS.md](../AGENTS.md) as the canonical customization inventory and [customization_architecture.md](../customization_architecture.md) as the canonical rationale.
