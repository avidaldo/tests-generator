...
File-scoped instructions for Python, notebooks, Markdown, editor, results, prompts, and documentation-sync rules live in [instructions/](instructions/) and are applied automatically based on `applyTo` glob patterns.
