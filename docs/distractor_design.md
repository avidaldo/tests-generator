...
This document is the knowledge base for distractor (incorrect answer) design in multiple-choice questions. It is referenced directly by `prompts/generate-questions.prompt.md`.
